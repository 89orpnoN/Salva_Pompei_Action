...
var Weapons = {
	...
	"ak-47":BaseClasses.Gun(null,0.1,34,8000,10000,10,0.15,30,3.5,false,1,BaseClasses.GunAppearance(load("res://Sprites/Guns/ak47.bmp"),Vector2(1,-21.3333),Vector2(1,1))),
}
