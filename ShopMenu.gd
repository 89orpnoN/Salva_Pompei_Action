...
func _on_shop_button_pressed():
	if Opener.Money >= GunList.get_selected_items()[0]:
		BaseClasses.SpawnGroundObj(get_node("/root/World"),Opener.Target.global_position,ItemsList[GunList.get_selected_items()[0]].GroundObject)
